...
<head>
    ...
    <title>小白旅游网站后台登陆</title>

    <style type="text/css">
        *{padding:0px;margin:0px;}
        body{font-family:Arial, Helvetica, sans-serif;background:url(../../images/grass2.jpg);font-size:12px;}
        img{border:0;}
...
<div class="lg">
    <form action="/login" method="POST">
        ...
        <div class="lg_main">
            <div class="lg_m_1">
                ${error}
                    <label>用户名</label><input name="name" id="name" placeholder="用户名" value="" class="ur" />
                    <label>密码</label><input name="password" id="password" placeholder="密码" type="password" value="" class="pw" />
