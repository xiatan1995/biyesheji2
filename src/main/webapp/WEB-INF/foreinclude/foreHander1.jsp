            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 5分钟内未收到线路信息,请拨打电话  <span class="support-no">: (0451) 800 800 800</span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
    ...
    <div class="navigation-menu-top navigation-menu-top-home-4 pt-35 pb-35 pt-md-15 pb-md-15 pt-sm-15 pb-sm-15 mb-md-55 mb-sm-55">
        <div class="container">
            <div class="row align-items-center">
                <img src="${pageContext.request.contextPath}/assets/images/top_banner.jpg" class="img-fluid" alt="">
            </div>
        </div>
    </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-lg-3 col-md-12 col-sm-12">
                    ...
                    <div class="hero-side-category">
                        ...
                        <div class="category-toggle-wrap">
                            <!-- Category Toggle -->
                            <button class="category-toggle" id="categorys"> <i class="fa fa-bars"></i> 线路分类 </button>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                <li><a href="/fore/forecart">我的线路</a></li>
                                <li><a href="/fore/forebought">我的订单</a></li>
                                <li><a href="/fore/foreZixuns">线路资讯</a></li>
